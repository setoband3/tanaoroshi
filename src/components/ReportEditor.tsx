  ...
  return (
    <tr className="border-b border-zinc-200" style={rowTintStyle(groupColor)}>
      ...
      <td className="p-1 align-top text-right">
        <input
          inputMode="numeric"
          className="w-[3.2rem] min-w-0 rounded border border-zinc-300 px-1.5 py-1.5 text-right text-sm tabular-nums dark:border-zinc-600 dark:bg-zinc-900"
          value={unitPrice}
        ...
        <table className="w-full min-w-[72rem] border-collapse text-sm">
          <thead>
            <tr className="bg-zinc-100 text-left text-zinc-700 dark:bg-zinc-900 dark:text-zinc-300">
              ...
              <th className="w-[3.2rem] px-2 py-2 text-right font-medium">単価（税抜）</th>
