  ...
  return (
    <tr className="border-b border-zinc-200" style={rowTintStyle(groupColor)}>
      ...
      <td className="p-1 align-top text-right">
        <input
          inputMode="decimal"
          className="w-full min-w-[1rem] rounded border border-zinc-300 px-1 py-1.5 text-right text-sm tabular-nums dark:border-zinc-600 dark:bg-zinc-900"
          value={quantity}
      ...
      <td className="p-1 align-top">
        <input
          className="w-full min-w-[1.4rem] rounded border border-zinc-300 px-1 py-1.5 text-sm dark:border-zinc-600 dark:bg-zinc-900"
          value={unit}
        ...
        <table className="w-full min-w-[72rem] border-collapse text-sm">
          <thead>
            <tr className="bg-zinc-100 text-left text-zinc-700 dark:bg-zinc-900 dark:text-zinc-300">
              ...
              <th className="min-w-[1rem] px-2 py-2 text-right font-medium">数量</th>
              <th className="min-w-[1.4rem] px-2 py-2 font-medium">単位</th>
